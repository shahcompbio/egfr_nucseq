...
```{r}
# luca <- readRDS(here("data", "external_data", "lc_atlas", "luca_extended.rds"))
#
# # Turn into on disk
# library(BPCells)
#
...
# rownames(mat) <- luca[["RNA"]]@meta.features$feature_name
# write_matrix_dir(mat, dir = here("data", "luca_bp"), overwrite = T)
#
# luca_ondisk <- CreateSeuratObject(counts = open_matrix_dir(here("data", "luca_bp")), meta.data = luca@meta.data)
# luca_ondisk <- NormalizeData(luca_ondisk)
# luca_ondisk@reductions <- luca@reductions
#
# saveRDS(luca_ondisk, file = here("data", "external_data", "lc_atlas", "luca_extended_ondisk.rds"))
```
