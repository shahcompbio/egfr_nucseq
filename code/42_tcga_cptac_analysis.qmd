...
scores_tcga <- read.table(here("data", "tcga_pathway_scores.txt.gz"), header = T, sep = "\t")
```
...
scores_cptac <- read.table(file = here("data", "cptac_pathway_scores.txt.gz"), header = T, sep = "\t")
```
